...
# Step 2: Filter by labour market demand
high_demand_degrees = [degree for degree in eligible_degrees if degree["demand_score"] >= 7]

# Step 3: Personalise using student interests
personalised_degrees = [
...
final_recommendations = personalised_degrees if personalised_degrees else high_demand_degrees
